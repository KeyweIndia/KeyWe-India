...
import Hero1 from '../../public/HeroImage.png'
import Image from 'next/image';
import Link from 'next/link';

const HeroSection = () => {
  return (
    <div className={` text-[#000000] pt-[90px]`}>
        ...
        <div className=' container mx-auto h-full '>
         ...
         <div className='w-full lg:w-[50%] flex flex-col justify-center items-center lg:items-start gap-5  '>
            ...
            <p className='text-[18px] font-Jost text-center lg:text-start text-gray-700 '>{`We offer expert Microsoft solutions backed by the latest technical knowledge and skills.`}</p>
