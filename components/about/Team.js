...
const Team = () => {
  ...
  <h2 className="lg:text-[40px] text-[22px] capitalize text-center text-white font-bold">Our Managing Directors</h2>
  <hr className="mx-auto w-16 h-1 outline-0 border-0 bg-primary block mt-4 mb-6" />
  <p className="text-center text-xl font-Jost text-gray-100">KeyWe is a group of creative and hardworking people who have come together to form the perfect team.</p>
  <div className="flex flex-col gap-6 mt-16">
    <div className="flex flex-col justify-center items-start lg:flex-row gap-6">
      <div className="w-full lg:w-1/4 flex flex-col justify-center items-center rounded-3xl overflow-hidden">
        ...
        <h3 className="text-2xl capitalize text-white font-semibold pt-4">Arjit Soni</h3>
        <span className="inline-block capitalize text-xl text-gray-200 font-light mt-1.5 mb-5">CEO & Founder</span>
      </div>
      <div className="w-full lg:w-9/12 border bg-transparent/20 rounded-3xl flex flex-col justify-center p-8 lg:p-14">
