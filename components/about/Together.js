  ...
  return (
    <div className=' py-20'>
      <div className='container mx-auto'>
        <div>
           <h2 className="lg:text-[40px] text-[22px] capitalize text-center text-white font-bold">Want To Work Together?</h2> 
        </div>
...
<div className='flex flex-col justify-center items-center gap-3'>
    ...
    <h4 className='text-[20px] font-Jost text-gray-100 font-medium'>Connect</h4>
</div>
<div className='flex flex-col justify-center items-center gap-3'>
    <div>
        <Image src={S2} alt='' className='w-full h-full object-cover'/>
    </div>
    <h4 className='text-[20px] font-Jost text-gray-100 font-medium'>Business Analysis</h4>
</div>
<div className='flex flex-col justify-center items-center gap-3'>
    <div>
        <Image src={S3} alt='' className='w-full h-full object-cover'/>
    </div>
    <h4 className='text-[20px] font-Jost text-gray-100 font-medium'>Proposal</h4>
</div>
<div className='flex flex-col justify-center items-center gap-3'>
    <div>
        <Image src={S4} alt='' className='w-full h-full object-cover'/>
    </div>
    <h4 className='text-[20px] font-Jost text-gray-100 font-medium'>Work Contract
</h4>
</div>
<div className='flex flex-col justify-center items-center gap-3'>
    <div>
    ...
    <h4 className='text-[20px] font-Jost text-gray-100 font-medium'>Project Initiation</h4>
</div>
